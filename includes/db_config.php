...
function getDbConnection() {
    ...
    try {
        ...
        $options = [
            ...
            // CORRECTION: Ajout de ces options
        ...
        // CORRECTION: Vérification de la connexion
        $pdo->query('SELECT 1');

        return $pdo;
    } catch (PDOException $e) {
        // CORRECTION: Log plus détaillé
        $error_msg = "Erreur de connexion à la base de données: " . $e->getMessage();
        error_log($error_msg);

        // CORRECTION: Si logger.php est inclus, utiliser cette fonction
