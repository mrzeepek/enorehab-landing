 ...
 <!--   <h3 class="text-2xl font-bold mb-8 text-center">Ils m'ont fait confiance</h3>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-[#111111] p-6 rounded-lg">
            ...
            <p class="text-gray-300 mb-4">"Je préparais ma première compétition Hyrox quand une douleur à l'épaule m'a stoppée. Le programme d'Enora était parfait pour continuer l'entraînement sans aggraver la blessure. J'ai pu participer et finir ma course sans douleur!"</p>
            <p class="font-medium">Marie L. - Hyrox Competitor</p>
        </div>
        ...
        <div class="bg-[#111111] p-6 rounded-lg">
            ...
            <p class="text-gray-300 mb-4">"En tant qu'haltérophile, j'étais frustré par ma douleur à l'épaule qui m'empêchait de progresser. Le bilan d'Enora a révélé des défauts techniques que je ne soupçonnais pas. Son approche personnalisée m'a permis d'améliorer ma technique et d'éliminer la douleur."</p>
            <p class="font-medium">Lucas B. - Weightlifter</p>
        </div>
    </div>
</div>
    </div>
...
<!-- Ajouter ce code avant le formulaire dans la section CTA FINAL -->
...
<section id="booking" class="py-20 bg-black text-white px-4">
    <div class="container mx-auto text-center">
        ...
        <!-- Ou alternativement, intégration Calendly -->
        <!--
